...
import com.xiongsu.api.vo.article.dto.ColumnArticlesDTO;
import com.xiongsu.api.vo.article.dto.ColumnDTO;
import com.xiongsu.api.vo.seo.Seo;
import com.xiongsu.api.vo.seo.SeoTagVo;
...
import com.xiongsu.web.controller.user.vo.UserHomeVo;
...
public class SeoInjectService {
     ...
     * @param user
     */
    public void initUserSeo(UserHosmeVo user) {
        Seo seo = initBasicSeoTag();
        List<SeoTagVo> list = seo.getOgp();
        Map<String, Object> jsonLd = seo.getJsonLd();
