...
import com.xiongsu.api.enums.pay.PayStatusEnum;
...
import com.xiongsu.api.vo.article.dto.PayConfirmDTO;
import com.xiongsu.api.vo.constants.StatusEnum;
import com.xiongsu.api.vo.dto.PayInfoDTO;
...
import com.xiongsu.core.util.PriceUtil;
import com.xiongsu.core.util.SpringUtil;
import com.xiongsu.core.util.id.IdUtil;
import com.xiongsu.service.article.conveter.PayConverter;
import com.xiongsu.service.article.repository.dao.ArticlePayDao;
import com.xiongsu.service.article.repository.entity.ArticleDO;
import com.xiongsu.service.article.repository.entity.ArticlePayRecordDO;
...
public class ArticlePayServiceImpl implements ArticlePayService {
    ...
    @Override
    public boolean hasPayed(Long article, Long currentUserId) {
        ArticlePayRecordDO dbRecord = articlePayDao.queryRecordByArticleId(article,currentUserId);
        if (dbRecord == null) {
            return false;
        }
